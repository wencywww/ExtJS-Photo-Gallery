...
![preview](screenshots/gallery-screenshot.png)
![preview](screenshots/gallery-screenshot-2.png)
![preview](screenshots/gallery-screenshot-3.png)
...
**INSTALLATION**
  ...
  * **Using Docker image (recommended)**
    ...
    The gallery is available as multi-arch a Docker image from [Docker Hub](https://hub.docker.com/r/wencywwww/extjs-photo-gallery), requiring only minimal configuration (username, password and Maps API key). Docker-specific instructions available at the [docker sub-dir](docker/docker-README.md) in this repo.
